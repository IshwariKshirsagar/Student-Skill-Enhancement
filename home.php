                    ...
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            if($_SESSION['login_user_type'] == 1){
                                ...
                                $sql = "SELECT count(*) as total_course FROM course_database WHERE event_organizer_id=".$_SESSION['login_user_id'];
                            }
